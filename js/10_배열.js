...
function check2(){
    ...
    // weeks.length == 7
    // weeks의 시작 인덱스 번호 : 0
    // weeks의 마지막 인덱스 번호 : 8 === weeks.length - 1
    // index는 0 이상의 정수
    // index는 1씩 증가
...
/* 
    ...
    2) 합계 출력
    3) 평균 출력
    4) 짝수 번째 index 요소의 합계 출력(0, 2, 4)
    5) 홀수 번째 index 요소의 합계 출력(1, 3)
*/
function check4(){
    // 1) 저장된 값 출력
...
/* 배열 길이를 입력 받아 배열을 생성하고
    생성 배열 각 요소에 @에서 배열 길이 미만의 난수를 저장
*/
function check5(){
...
/**  로또 번호 생성기 */
/* 
  배열.includes(값) : () 내 값 배열에 존재하면 true, 없으면 fals
*/
function createLottoNumber(){
  // id가 lotto인 요소를 얻어와 변수에 저장
