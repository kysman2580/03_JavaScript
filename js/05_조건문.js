  ...
  */
  ...
  function check5(){
    ...
    switch ( Number(input5.value) ){
      ...
      default : result = "3,4,5 가 아닌 다른 숫자가 입력되었습니다";
    }
  ...
  // 매개 변수(Parameter)
  // - 함수가 호출될 때 전달될 값(전달 인자, Argument)을
  //   저장하기 위한 변수

  /** switch 문을 이용한 계산기 */
  function calc(op){
    console.log("매개 변수 확인 : ", op, "op의 타입 : " + typeof op);
