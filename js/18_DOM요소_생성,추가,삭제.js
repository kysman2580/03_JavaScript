...
for(let btn of btns){
  btn.addEventListener("click", (e)=>{
    ...
    switch(str){
      ...
      case "after" :
        const div2 = document.createElement("div"); // div 요소 생성
        div2.className = "box"; //  div 요소에 box 클래스 추가
        div2.style.backgroundColor = "springgreen";
        div2.innerText = count; // div의 내용으로 count 추가
                                // (TextNode 사용 안 하는 방법)

        standard.after(div2);  // #standard 뒤쪽에 추가
